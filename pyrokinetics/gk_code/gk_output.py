...
class GKOutput(DatasetWrapper):
    ...
    def __init__(
        ...
        data_vars = {
            "phi": make_var(("theta", "kx", "ky", "time"), phi, "Electrostatic potential"),
            "apar": make_var(("theta", "kx", "ky", "time"), apar, "Parallel magnetic vector potential"),
            "bpar": make_var(("theta", "kx", "ky", "time"), bpar, "Parallel magnetic field"),
            "particle": make_var(("species", "moment", "field", "ky", "time"), particle, "Particle flux"),
            "momentum": make_var(("species", "moment", "field", "ky", "time"), momentum, "Momentum flux"),
            "heat": make_var(("species", "moment", "field", "ky", "time"), heat, "Heat flux"),
            "growth_rate": make_var(("kx", "ky", "field", "theta", "time"), growth_rate, "Growth rate"),
            "mode_frequency": make_var(("theta", "kx", "ky", "time"), mode_frequency, "Mode frequency"),
            "eigenvalues": make_var(("theta", "kx", "ky", "time"), eigenvalues, "Eigenvalues"),
            "eigenfunctions": make_var(("field", "theta", "kx", "ky", "time"), eigenfunctions, "Eigenfunctions"),
        }
