...
class GKOutputReaderGFTM(GKOutputReader):
    ...
    @classmethod
    def _init_dataset(
        cls, raw_data: Dict[str, Any], gk_input: GKInputGFTM
    ) -> xr.Dataset:
        """
    ...
    @staticmethod
    def _set_fields(
        data: xr.Dataset, raw_data: Dict[str, Any], gk_input: GKInputGFTM
    ) -> xr.Dataset:
        """
        ...
        # FIXME Currently using "nonlinear" GFTM also generates the linear growth rates
