...
class GKInputWriterGS2(GKInputWriter):
    ...
    def write(self, filename: PathLike, local_geometry: LocalGeometry, local_species: LocalSpecies, numerics: Numerics, directory: Optional[PathLike] = None, float_format: str = ""):
        """
        ...
        # Kinetic data
        gs2_input = self.local_species_to_gs2_input(gs2_input, local_species, local_geometry)

        # Numerics
        gs2_input = self.numerics_to_gs2_input( gs2_input, numerics)
    ...
    @staticmethod
    def local_species_to_gs2_input( gs2_input: Dict[str,Any], local_species: LocalSpecies, local_geometry: LocalGeometry)
    ...
    @staticmethod
    def numerics_to_gs2_input( gs2_input: Dict[str,Any], numerics: Numerics):
