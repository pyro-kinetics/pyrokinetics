...
cgyro_template = "C:\\Users\\bpatel2\OneDrive - UKAEA\Documents\pyro_test\CGYRO_linear\input.cgyro"
# Load in file
...
# Point to CGYRO input file
gene_template = "C:\\Users\\bpatel2\OneDrive - UKAEA\Documents\pyro_test\GENE_linear\parameters"
...
# Point to CGYRO input file
gs2_template = "C:\\Users\\bpatel2\OneDrive - UKAEA\Documents\pyro_test\GS2_linear\gs2.in"
...
# Point to CGYRO input file
cgyro_nl_template = "C:\\Users\\bpatel2\OneDrive - UKAEA\Documents\pyro_test\CGYRO_run\input.cgyro"
# Load in file
pyro = Pyro(gk_file=cgyro_nl_template, gk_code="CGYRO")
# Load in CGYRO output data
pyro.load_gk_output()
data = pyro.gk_output
ids = pyro_to_ids(pyro, comment="Testing IMAS CGYRO NL", name='testing', ref_dict=ref_dict)
