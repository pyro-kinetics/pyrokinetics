...
def test_gk_codes_output():
    ...
    cgyro = Pyro(gk_file=template_dir / "outputs/CGYRO_linear/input.cgyro", gk_code='CGYRO')
    ...
    gene = Pyro(gk_file=template_dir / "outputs/GENE_linear/parameters_0001", gk_code='GENE')
