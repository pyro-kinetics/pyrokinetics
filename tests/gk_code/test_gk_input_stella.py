...
template_file_v1 = template_dir / "input.stella"
template_file_nl = template_dir / "input.stella_pre_v1_nl"
...
# src/pyrokinetics/templates/input.stella_pre_v1. It represents stella's authoritative
