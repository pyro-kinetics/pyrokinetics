...
from pyrokinetics.kinetics import Kinetics, KineticsReaderELITEINP
from pyrokinetics.species import Species


class TestKineticsReaderELITEINP:
    @pytest.fixture
    def transp_reader(self):
        return KineticsReaderELITEINP()
    ...
    def test_read(self, transp_reader, example_file, example_eq):
        """
        Ensure it can read the example ELITEINP file, and that it produces a Species dict.
        """
        result = transp_reader(example_file, eq=example_eq)
