...
class Pyro:
    ...
    def load_metric_terms(
            self, ntheta: Optional[int] = None, theta: Optional[List] = None, sonic=False, mu0F_rho=None,
    ):
        """
        ...
        self.metric_terms = MetricTerms(self.local_geometry, ntheta=ntheta, theta=theta, sonic=sonic, mu0F_rho=mu0F_rho)
